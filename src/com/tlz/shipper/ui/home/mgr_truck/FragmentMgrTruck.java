package com.tlz.shipper.ui.home.mgr_truck;
...
public class FragmentMgrTruck extends ThemeFragment implements
		OnGroupCollapseListener, OnChildClickListener, OnGroupExpandListener,
		OnGroupClickListener {
	private ExpandableListView listView = null;
	private ExpandableListApapterMgrTruck adapter;
	private ActivityHome homeActivity;
	private ArrayList<WaybillNews> list;

	public static FragmentMgrTruck newInstance() {
		return new FragmentMgrTruck();
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.add(new WaybillNews());
		adapter = new ExpandableListApapterMgrTruck(homeActivity, list);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_mgr_truck, container, false);
		initView(v);
		return v;
	}
