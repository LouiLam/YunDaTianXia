...
public class ExpandableListApapterMgrTruck extends BaseExpandableListAdapter {

	private ActivityHome mContext;
	private List<WaybillNews> mChildData1 = new ArrayList<WaybillNews>();


	public ExpandableListApapterMgrTruck(ActivityHome context, List<WaybillNews> datas) {
		mContext = context;
