...
public class ExpandableListApapterMe extends BaseExpandableListAdapter {

	private ActivityHome mContext;
	private List<WaybillNews> mChildData1 = new ArrayList<WaybillNews>();


	public ExpandableListApapterMe(ActivityHome context, List<WaybillNews> datas) {
		mContext = context;
...
//		}
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		String titles[]=mContext.getResources().getStringArray(R.array.me_titles);
		title.setText(titles[groupPosition]);
		icon.setBackgroundResource(ResIdentifier.getDrawbleIDByName(mContext, "icon_home_me_"+groupPosition));
