...
//
//public class ImageGridPickerActivityBackup extends ThemeActivity {
...
////									skipUI();
//									ToastUtils.showCrouton(ImageGridPickerActivityBackup.this, getString(R.string.upload_ok));
//								} else {
//									ToastUtils.showCrouton(ImageGridPickerActivityBackup.this, obj.getString("Message"));
//								}
//							} catch (Exception e) {
//								e.printStackTrace();
...
//							
//						}
//					}, ImageGridPickerActivityBackup.this).execute(new File(path));
//				}
//				else
//				{skipUI();}
//			}
...
//							ToastUtils.showCrouton(ImageGridPickerActivityBackup.this,
//									error+":"+obj.getInt("resultCode"));
//						} catch (Exception e) {
//							ToastUtils.showCrouton(ImageGridPickerActivityBackup.this,
//									ImageGridPickerActivityBackup.this.getString(R.string.error)+obj.getInt("resultCode"));
//						}
//						
//					}
//				} catch (Exception e) {
//					e.printStackTrace();
//					ToastUtils.showCrouton(ImageGridPickerActivityBackup.this,
//							ImageGridPickerActivityBackup.this.getString(R.string.exception));
//				}
//
//			}
//		}, ImageGridPickerActivityBackup.this).execute(Urls.REGEDIT);
//	
//	}
...
//			ContentResolver mContentResolver = ImageGridPickerActivityBackup.this
//					.getContentResolver();
//
//			// 只查询jpeg和png的图片
...
//					ImageGridPickerActivityBackup.this, mData,
