...
/**
 * 类型描述: 企业货主帐号相关的API </br>创建时期: 2014年12月22日
 * 
 * @author hyq
 */
public interface ShipperAccountApi {
	 ...
	 * 
	 * @return 返回一个会员帐号+会员信息数据的组合JSON对象ShipperLoginDTO,格式如下: { resultCode:1
	 *         :正确|-1:操作失败,0:用户名或密码有误 data:{ token:令牌 member:{ memberId:12,
	 *         phone:"会员手机号" loginName:"登陆名" creditGrad:(int)信誉等级
	 *         balance:(float)帐户余额 }, shipper:{ shipperId:(int)主键 head:"头像url"
	 *         auditStatus:(int)认证状态 locationCode :"所在地CODE" simpleName:"企业简称"
	 *         fullName:"企业全称" detailAddress:"详细地址" contact:"联系人" phone:"联系电话"
	 ...
	 * @param pwd
	 *            密码
	 * @return 返回一个json对象,格式如下; { resultCode:1 :注册成功| -1:操作失败, data:{
	 *         token:"会话令牌" memberId:77 } }
	 */
	 ...
	 *         token:"会话令牌" } }
	 */
	String registpc(String simpleName, String loaction, String password,
			String phone, String activecode);
	 ...
	 * @param sid
	 *            企业货主
	 * @return 返回企业货主详情json对象ShipperDTO,格式如下: { resultCode:1 :正确 | 0:会话超时 |
	 *         -1:操作失败, data:{字段格式如表tp_Shipper: businesslicence:{},
	 *         organizationno:{}, taxregistno:{} } 
		{
			"data":
		     		{
		       		"simpleName":"wow1",//企业简称或登陆名
		      		"phone":null,//电话
					"website":null,//企业网址
					"taxregistno":null,//税务登记号图
					"introduce":null,//简介
					"qrCode":null,//生成的二维码
					"contact":null,//联系人
					"detailAddress":null,//详细地址
					"locationCode":"湖南省 长沙市 岳麓区",//
					"auditStatus":0,//认证状态
					"organizationno":null,//组织机构图片对象
					"cargoType":0,//主要运送货品
					"serialVersionUID":1, 暂无用
					"fullName":null,//企业全称
					"head":null,//头像
					"businesslicence":null,//营业执照料图
					"shipperId":65 //货主主键
					}, 
			"resultCode":1
		}
	 ...
	 */
	String addReciever(int sid, String name, String addr, String contact,
			String phone, double lon, double lat);
	 ...
	 * @return {resultCode:1：删除成功,-2:会话超时,需要重新登陆,-1：删除失败 }
	 */
	String updateReciever(int rid, String name, String addr, String contact,
			String phone, double lon, double lat);
	 ...
	 * @param captcha
	 *            验证码
	 * @return { resultCode:1:验证成功，0：该帐号未注册,2:验证码不正确,-1:发生服务器异常 , }
	 */
	 ...
	 * 
	 * @param imageId
	 * @return { resultCode:1：操作成功，0：超时,-1:发生服务器异常 data: url }
	 */
	 ...
	 * 
	 * @param imageId
	 * @return { resultCode:1：操作成功，0：超时,-1:发生服务器异常 data: [
